                ...
                <div>
                  {item.image ? (
                    <Link to={`/news/${item.id}`} className="block overflow-hidden relative">
                      <img
                        src={resolveArticleImage(item.image, item.category || "तकनीक", item.id || item.title)}
                        alt={item.title}
                        onError={(e) => {
                          ...
                          if (item.image && item.image.startsWith("/uploads/") && !e.currentTarget.src.startsWith("https://swadeshvaani.com")) {
                            ...
                            e.currentTarget.src = getCategoryFallbackImage(item.category || "तकनीक", item.id || item.title);
                          }
                        }}
                  ...
                  {item.image ? (
                    <Link to={`/news/${item.id}`} className="block overflow-hidden relative">
                      ...
                      <div className="absolute left-3 top-3 flex flex-wrap gap-1">
                        ...
                        {item.district && (
                          <span className="px-2.5 py-1 bg-blue-950/80 rounded-full text-[10px] font-medium text-white shadow-sm">
                            📍 {item.district}
                          </span>
                        )}
                      </div>
