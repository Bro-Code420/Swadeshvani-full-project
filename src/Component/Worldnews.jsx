                ...
                <div>
                  {item.image ? (
                    <Link to={`/news/${item.id}`} className="block overflow-hidden relative">
                      <img
                        src={resolveArticleImage(item.image, item.category || "देश-विदेश", item.id || item.title)}
                        alt={item.title}
                        onError={(e) => {
                          ...
                          if (item.image && item.image.startsWith("/uploads/") && !e.currentTarget.src.startsWith("https://swadeshvaani.com")) {
                            ...
                            e.currentTarget.src = getCategoryFallbackImage(item.category || "देश-विदेश", item.id || item.title);
                          }
                        }}
